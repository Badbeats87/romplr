...
{
	// ARM_ALLOW_MULTI_CORE assert removed - bootloader is single-core,
	// but links against multi-core libs. Chainboot is safe here since
	// we never start secondary cores.
